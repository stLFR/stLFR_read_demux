...
if(@ARGV != 6)
{
        print "Example: perl Split_SingleTube_reads.2.1pl barcode.list barcode_RC.list read_1.fq.gz read_2.fq.gz 100 split_read \n";
        exit(0);
}

my $read_len = $ARGV[4];
my ($n1, $n2, $n3, $n4, $n5) = (10, 6, 10, 18, 10);
my %barcode_hash;
my %barcode_RC_hash;
...
open OUT2, ">split_stat_read2.log" or die "Can't write file";
